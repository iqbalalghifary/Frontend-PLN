...
const daftarFitProper = () => {
  ...
  const readGrade = () => axios.get(`${url}/api/grades?populate=jenjang_struktural`)
  const readPenguji = () => axios.get(`${url}/api/pengujis?populate[pegawai][populate]=grade`)
  const readJabatan = () => axios.get(`${url}/api/jabatans`)
  ...
  function dataJenjang(){
    ...
    console.log(idx)
    console.log(grade[idx].attributes.jenjang_struktural.data[0].attributes.nama_jenjang)
    for (let i = 0; i < grade[idx].attributes.jenjang_struktural.data.length; i++){
      var opt = document.createElement("option")
      opt.text = grade[idx].attributes.jenjang_struktural.data[i].attributes.nama_jenjang
      opt.value = grade[idx].attributes.jenjang_struktural.data[i].attributes.nama_jenjang
...
//       x.attributes.tingkat_grade === document.getElementById("grade").value)
//     console.log(idx)
//     console.log(grade[idx].attributes.jenjangs.data[0].attributes.jenjang_struktural)
//     for (let i = 0; i < grade[idx].attributes.jenjangs.data.length; i++){
//       var opt = document.createElement("option")
//       opt.text = grade[idx].attributes.jenjangs.data[i].attributes.jenjang_struktural
//       opt.value = grade[idx].attributes.jenjangs.data[i].attributes.jenjang_struktural
//       document.getElementById("jenjab").options.add(opt)
//       console.log(opt.text)
//       console.log(opt.value)
//     }
...
//                   {/* {grade.map((item)=>{
//                     return(
//                     <option value={item.attributes.jenjangs.data.id}>{item.attributes.jenjangs.data.jenjang_struktural}</option>
//                     )
//                   })} */}
//                   <CDropdownDivider />
//                 </CFormSelect>               
...
//             </CRow>
//             <CRow className="mb-3">
//               <CFormLabel htmlFor="urjab" className="col-sm-2 col-form-label">Urjab</CFormLabel>
//               <CCol sm={5}>
//                 <CFormInput type="text" id="urjab" placeholder="Uraian Jabatan"/>            
//               </CCol>
//             </CRow>
