  ...
  function submit(e) {
    ...
    axios.post(uri,{
      data : {
        ...
        file_ppt_wwc : document.getElementById("ppt").value,
        file_cv_wwc : document.getElementById("doc").value,
    ...
    .then(res=>{
      ...
      axios.post(upload, formData).then((res2)=>{
        console.log(res2)
      })
    })
        ...
        <CCard className="mb-4">  
          ...
          <CForm
            ...
            <CRow className="mb-3">
              ...
              <CCol sm={10}>
                <CFormInput type="file" id="doc" onChange={handleFileSelect}/>            
              </CCol>
            </CRow>
            <CRow className="mb-3">
