      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <CInputGroup className="mb-3">
              <CFormInput placeholder="Nama" aria-label="Nama" aria-describedby="button-addon2" />
            </CInputGroup>
            ...
            <CInputGroup className="mb-3">
              <CFormInput placeholder="Grade" aria-label="Grade" aria-describedby="button-addon2" />
            </CInputGroup>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/input-group#multiple-inputs">
              <CInputGroup>
                <CInputGroupText>First e</CInputGroupText>
